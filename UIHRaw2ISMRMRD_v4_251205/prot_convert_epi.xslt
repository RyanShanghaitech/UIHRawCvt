...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- variable begin -->
		...
		<xsl:variable name="RampSampling"          		select="/UProtocol/Root/Seq/App/FreePara7/Value" />
		
		<xsl:variable name="GroGradAmp_mT_m"          	select="/UProtocol/Root/IRIP/FromSeq/App/GroGradAmp_mT_m/Value" />
		<xsl:variable name="GroGradRampTime_us"        	select="/UProtocol/Root/IRIP/FromSeq/App/GroGradRampTime_us/Value" />
		...
		<xsl:variable name="AdcDwellTime_ns"          	select="/UProtocol/Root/IRIP/FromSeq/App/AdcDwellTime_ns/Value" />
		<xsl:variable name="AdcTotalNumber"          	select="/UProtocol/Root/IRIP/FromSeq/App/AdcTotalNumber/Value" />
		<xsl:variable name="RegridNumber"          		select="/UProtocol/Root/IRIP/FromSeq/App/RegridNumber/Value" />
    ...
    <ismrmrdHeader xmlns="http://www.ismrm.org/ISMRMRD" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" xsi:schemaLocation="http://www.ismrm.org/ISMRMRD ismrmrd.xsd" >
		...
		<encoding>
			...
			<trajectoryDescription>
				...
				<comment>ConventionalEPI:RampSampling; UR:UnRampSampling</comment>
			</trajectoryDescription>
		</encoding>
